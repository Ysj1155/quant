...
- model별 MAE / RMSE 집계
- 최근 N일 성능 비교
- ensemble vs individual 모델 비교

### 2. Adaptive Ensemble
- DB에 쌓인 실제 오차 기반 weight 재계산
- rolling window 기반 가중치 업데이트

### 3. Automation
- account forecast save 스케줄러 추가
- account actual update 스케줄러 추가
